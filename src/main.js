(() => {
  ...
  const loaderStepVisual = $('#loaderStepVisual');
  const loaderStepVideo = $('#loaderStepVideo');
  const loaderStepFonts = $('#loaderStepFonts');
  const loaderStepReady = $('#loaderStepReady');
  ...
  function setLoaderStep(el, state = 'active') {
    if (!el) return;
  ...
  function closeLoader() {
    ...
    loaderClosed = true;
    setLoaderStep(loaderStepReady, 'done');
  ...
  async function init() {
    ...
    if (!visualsOK) setLoaderStep(loaderStepVisual, 'warn');
    if (!videoBlobOK) setLoaderStep(loaderStepVideo, 'warn');
    ...
    setLoaderStep(loaderStepReady, 'active');
